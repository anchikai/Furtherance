	...
	if Mod.NoahsArkIdx ~= nil and level:GetCurrentRoomIndex() == Mod.NoahsArkIdx then
		if room:IsFirstVisit() then
			...
			for p = 0, game:GetNumPlayers() - 1 do
				...
				local baby = game:Spawn(EntityType.ENTITY_PICKUP, PickupVariant.PICKUP_COLLECTIBLE, room:GetCenterPos(),
					Vector.Zero, nil, ID1, room:GetSpawnSeed()):ToPickup()
				...
				local baby = game:Spawn(EntityType.ENTITY_PICKUP, PickupVariant.PICKUP_COLLECTIBLE,
					room:GetGridPosition(63), Vector.Zero, nil, ID2, room:GetSpawnSeed()):ToPickup()
				baby.OptionsPickupIndex = 2
				repeat
				...
				local baby = game:Spawn(EntityType.ENTITY_PICKUP, PickupVariant.PICKUP_COLLECTIBLE,
					room:GetGridPosition(71), Vector.Zero, nil, ID3, room:GetSpawnSeed()):ToPickup()
				baby.OptionsPickupIndex = 2
			end
		end
	end
