...
Encyclopedia.AddItem({
	ModName = "Furtherance",
	Class = "Furtherance",
	ID = CollectibleType["BINDS_OF_DEVOTION.ID"],
...
Encyclopedia.AddCharacterTainted({
	...
	Sprite = Encyclopedia.RegisterSprite(mod.path .. "content-dlc3/gfx/characterportraitsalt.anm2", "Leah", 0,
		mod.path .. "content-dlc3/gfx/charactermenu_leahb.png"),
...
Encyclopedia.AddCharacterTainted({
	...
	Sprite = Encyclopedia.RegisterSprite(mod.path .. "content-dlc3/gfx/characterportraitsalt.anm2", "Peter", 0,
		mod.path .. "content-dlc3/gfx/charactermenu_peterb.png"),
...
Encyclopedia.AddCharacterTainted({
	...
	Sprite = Encyclopedia.RegisterSprite(mod.path .. "content-dlc3/gfx/characterportraitsalt.anm2", "Miriam", 0,
		mod.path .. "content-dlc3/gfx/charactermenu_miriamb.png"),
