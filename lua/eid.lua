...
-- Chi Rho
EID:addCollectible(CollectibleType.COLLECTIBLE_CHI_RHO, "Lasers now home on enemies#They will stay put where they were fired, similarly to {{Collectible222}}Anti-Gravity#!!! Will not do anything if you don't fire lasers", "Chi Rho", "en_us")
