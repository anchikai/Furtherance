...
itemTable = {
	...
	[Item.BOOK_OF_LEVITICUS.ID] = {
		...
		Description = {
			function(descObj)
				return itemTable[Item.BOOK_OF_LEVITICUS.ID]._modifier(descObj)
			end
		}
	},
	[Item.BOOK_OF_SWIFTNESS.ID] = {
		...
		Description = {
			function(descObj)
				return itemTable[Item.BOOK_OF_SWIFTNESS.ID]._modifier(descObj)
			end
		}
	},
	[Item.BRUNCH.ID] = {
	...
	[Item.KEY_CAPS.ID] = {
		...
		Description = {
			function(descObj)
				return itemTable[Item.KEY_CAPS.ID]._modifier(descObj)
			end
		}
	},
	[Item.KEY_E.ID] = {
	...
	[Item.PALLAS.ID] = {
		...
		Description = {
			...
			function(descObj)
				return itemTable[Item.PALLAS.ID]._modifier(descObj,
